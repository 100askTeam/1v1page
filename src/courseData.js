export const audiences = [
  { icon: '求', title: '找工作的应届生', question: '简历雷同，面试无话？', detail: '基础零碎，学了忘，无项目经验；简历空白，无面试机会。' },
  { icon: '升', title: '想提升能力的工程师', question: '入门到放弃，无法推进，不敢跳槽？', detail: '加班累，技术停滞，无毅力无方向。' },
  { icon: '转', title: '换行业的工程师', question: '没接触过嵌入式，有人指导就能入行？', detail: '旧方向难就业，想转行嵌入式无门路。' }
]

export const serviceSteps = [
  { no: '01', title: '基础与目标评估', text: '根据你的基础、兴趣和就业目标，找准学习起点。' },
  { no: '02', title: '工程项目导向', text: '少上课，多规划路线；缺什么补什么，下发项目。' },
  { no: '03', title: '监督学习', text: '提供学习资料与针对性辅导，全程答疑、盯进度。' },
  { no: '04', title: '逐步验收', text: '每个阶段围绕项目验收，最终实现你的学习目标。' }
]
...
export const students = [
  {
    ...
    goal: '拿下要求全面的嵌入式企业 Offer，吃透原理，图 MCU / RTOS 核心功能。',
    review: '基础虽弱但有入门底子，不用盲目补零散知识点！',
    promise: '跟着这套路线走，6 个月后你完全能匹配企业招聘要求！',
    milestones: [
    ...
    projects: ['万能红外遥控器（不用 HAL 库）', '把项目 1 使用 HAL 库快速做出来', '串口服务器', '小动物 CT 机控制系统', '模仿制作心仪企业的产品'],
    projectDetails: [
      '拆解功能：遥控器协议/GPIO/PWM/SPI LCD/IIC转换屏；结合原理图阅读芯片手册，写各个模块代码；集成代码，学习数字电路、ARM架构程序分层设计。',
      '熟悉HAL库用法；快速移植项目。',
      '疯狂学习，给出技术方案；拆解功能：AT模块编程、socket接口封装、http协议、服务端编程、网页编程；使用编程规范实现代码，合并联调；掌握子系统划分、分层设计、面向对象编程。',
      '设计产品框架，编写用户/技术故事；评估核心技术，编写上位机程序；学习FreeRTOS技能、Modbus协议，编写中控程序，编写捕控板程序。',
      '使用ESP32开发板+血压测量模块搭建模型；编写ESP32程序：在界面显示血压，能通过蓝牙连接手机；在手机开发一个小程序，显示数据。'
    ]
  },
  {
    id: 'B',
    ...
    goal: '拿下机械智能化企业 Offer，掌握 GUI 开发能力、Linux 开发核心技能和音视频开发能力。',
    review: '有软件开发基础就是最大优势！你需要熟悉嵌入式方面的开发技能。',
    promise: '你有底子，我有 23 年工作经验和 17 年培训经验。全程带练、解难、盯进度，跟着执行，6 个月必达标！',
    milestones: [
  ...
  },
  {
    ...
    goal: '具备独立的 Linux 驱动 / BSP 开发能力，精准匹配企业高薪岗位要求。',
    review: '你的痛点我秒懂，目标我来帮你落地！',
    promise: '我全程盯着、带着、帮着你，把零散知识点变成能落地的实战能力。',
    milestones: [
  ...
  },
  {
    ...
    goal: '掌握 RTOS、Linux APP / 驱动与 AI 异构系统，形成全栈硬实力。',
    review: '定制化全栈进阶路线：POSIX 接口打通双系统，项目驱动全栈能力拉满！',
    promise: '17 年嵌入式实战教学经验，快速吃透 RTOS、Linux 全栈开发，掌握嵌入式 + AI 跨界技能。',
    milestones: [
  ...
  },
  {
    ...
    goal: '掌握核心技能，实现职业升级，塑造 RTOS 高薪 Offer 自信形象。',
    review: '定制跳槽提升路线：盘活老经验，直击企业招聘要求，4 个项目稳拿 Offer。',
    promise: '不浪费你的老经验、不绕远路、直击跳槽目标；短短 6 个月，带着实打实的项目经验去面试！',
    milestones: [
